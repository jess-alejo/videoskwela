!(function (e, a) {
  ...
  function Re(e, a, t, s, n) {
    ...
    return (r = _ <= 0 ? Te((d = e - 1)) + _ : _ > Te(e) ? ((d = e + 1), _ - Te(e)) : ((d = e), _)), {year: d, dayOfYear: r};
  }
  function Ce(e, a, t) {
    var s,
      n,
    ...
    return (
      r < 1 ? (s = r + Ie((n = e.year() - 1), a, t)) : r > Ie(e.year(), a, t) ? ((s = r - Ie(e.year(), a, t)), (n = e.year() + 1)) : ((n = e.year()), (s = r)),
      {week: s, year: n}
    );
  }
  function Ie(e, a, t) {
  ...
  function _a(e) {
    ...
    if (!na[e] && 'undefined' != typeof module && module && module.exports)
      try {
        (a = aa._abbr), require('moment/locale/' + e), ia(a);
      } catch (e) {}
    return na[e];
  }
  function ia(e, a) {
      ...
      t &&
        ...
        ((a =
          t[Le] < 0 || 11 < t[Le]
            ...
            ? ce
            : t[Ye] < 0 || 24 < t[Ye] || (24 === t[Ye] && (0 !== t[ye] || 0 !== t[fe] || 0 !== t[ke]))
            ? Ye
            : t[ye] < 0 || 59 < t[ye]
            ? ye
            : t[fe] < 0 || 59 < t[fe]
          ...
          e._w &&
            ...
            (function (e) {
              ...
              if (null != (a = e._w).GG || null != a.W || null != a.E)
                (d = 1), (r = 4), (t = la(a.GG, e._a[he], Ce(Ha(), 1, 4).year)), (s = la(a.W, 1)), ((n = la(a.E, 1)) < 1 || 7 < n) && (i = !0);
              else {
      ...
      24 === e._a[Ye] && 0 === e._a[ye] && 0 === e._a[fe] && 0 === e._a[ke] && ((e._nextDay = !0), (e._a[Ye] = 0)),
        (e._d = (e._useUTC
          ...
          : function (e, a, t, s, n, d, r) {
              ...
              return (
                e < 100 && 0 <= e
                  ? ((_ = new Date(e + 400, a, t, s, n, d, r)), isFinite(_.getFullYear()) && _.setFullYear(e))
  ...
  function ga(e) {
    ...
    if (n) {
      ...
      if (((a = n[1]), (t = d), (s = e), a && Ve.indexOf(a) !== new Date(t[0], t[1], t[2]).getDay() && ((Y(s).weekdayMismatch = !0), !(s._isValid = !1))))
        return;
      (e._a = d),
    ...
    if (e._f !== l.ISO_8601)
      if (e._f !== l.RFC_2822) {
        ...
        for (s = U(e._f, e._locale).match(z) || [], a = 0; a < s.length; a++)
          (n = s[a]),
            (t = (o.match(oe(n, e)) || [])[0]) &&
              (0 < (d = o.substr(0, o.indexOf(t))).length && Y(e).unusedInput.push(d), (o = o.slice(o.indexOf(t) + t.length)), (u += t.length)),
            R[n]
              ? (t ? (Y(e).empty = !1) : Y(e).unusedTokens.push(n), (r = n), (i = e), null != (_ = t) && h(ue, r) && ue[r](_, i._a, i, r))
        ...
        : ('string' == typeof d && (e._i = d = e._locale.preparse(d)),
          D(d)
            ...
            : (u(d)
                ...
                ? (function (e) {
                    ...
                    for (n = 0; n < e._f.length; n++)
                      (d = 0),
                        ...
                        (a._f = e._f[n]),
                        wa(a),
                        y(a) && ((d += Y(a).charsLeftOver), (d += 10 * Y(a).unusedTokens.length), (Y(a).score = d), (null == s || d < s) && ((s = d), (t = a)));
                    L(e, t || a);
                  })(e)
                : r
                ? wa(e)
                ...
                ? ((s = a),
                  null === (n = fa.exec(s._i))
                    ? (ka(s), !1 === s._isValid && (delete s._isValid, ga(s), !1 === s._isValid && (delete s._isValid, l.createFromInputFallback(s))))
                    : (s._d = new Date(+n[1])))
                : _(t)
  ...
  function Ja(e, a) {
    var t, s;
    return a._isUTC
      ? ((t = a.clone()), (s = (D(e) || u(e) ? e.valueOf() : Ha(e).valueOf()) - t.valueOf()), t._d.setTime(t._d.valueOf() + s), l.updateOffset(t, !1), t)
      : Ha(e).local();
  }
  function Na(e) {
  ...
  function Ua(e, a) {
    ...
    return (
      Wa(e)
        ...
        : (r = Ca.exec(e))
        ? ((t = '-' === r[1] ? -1 : 1), (d = {y: 0, d: g(r[ce]) * t, h: g(r[Ye]) * t, m: g(r[ye]) * t, s: g(r[fe]) * t, ms: g(Aa(1e3 * r[ke])) * t}))
        : (r = Ia.exec(e))
        ? ((t = '-' === r[1] ? -1 : 1), (d = {y: Ga(r[2], t), M: Ga(r[3], t), w: Ga(r[4], t), d: Ga(r[5], t), h: Ga(r[6], t), m: Ga(r[7], t), s: Ga(r[8], t)}))
        : null == d
        ? (d = {})
        : 'object' == typeof d &&
          ('from' in d || 'to' in d) &&
  ...
  (Mt.add = $a),
    ...
    (Mt.isAfter = function (e, a) {
      ...
      return (
        ...
        ('millisecond' === (a = P(a) || 'millisecond') ? this.valueOf() > t.valueOf() : t.valueOf() < this.clone().startOf(a).valueOf())
      );
    }),
    (Mt.isBefore = function (e, a) {
      ...
      return (
        !(!this.isValid() || !t.isValid()) &&
        ('millisecond' === (a = P(a) || 'millisecond') ? this.valueOf() < t.valueOf() : this.clone().endOf(a).valueOf() < t.valueOf())
      );
    }),
    ...
    (Mt.isSame = function (e, a) {
      ...
      return (
        ...
        ('millisecond' === (a = P(a) || 'millisecond')
          ...
          : ((t = s.valueOf()), this.clone().startOf(a).valueOf() <= t && t <= this.clone().endOf(a).valueOf()))
      );
    }),
    ...
    (Mt.toISOString = function (e) {
      ...
      return t.year() < 0 || 9999 < t.year()
        ? I(t, a ? 'YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYYYY-MM-DD[T]HH:mm:ss.SSSZ')
        : H(Date.prototype.toISOString)
        ? a
          ? this.toDate().toISOString()
          : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace('Z', I(t, 'Z'))
        : I(t, a ? 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYY-MM-DD[T]HH:mm:ss.SSSZ');
    }),
    (Mt.inspect = function () {
      ...
      return (
        ...
        n !== e &&
          (!a || this._changeInProgress
            ...
            : this._changeInProgress || ((this._changeInProgress = !0), l.updateOffset(this, !0), (this._changeInProgress = null))),
        this
      );
    }),
    (Mt.utc = function (e) {
  ...
  (Lt.calendar = function (e, a, t) {
    ...
    (Lt.monthsParse = function (e, a, t) {
      ...
      for (this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), s = 0; s < 12; s++) {
        if (
          ...
          t ||
            this._monthsParse[s] ||
            ((d = '^' + this.months(n, '') + '|^' + this.monthsShort(n, '')), (this._monthsParse[s] = new RegExp(d.replace('.', ''), 'i'))),
    ...
    (Lt.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (h(this, '_monthsRegex') || ze.call(this), e ? this._monthsStrictRegex : this._monthsRegex)
        : (h(this, '_monthsRegex') || (this._monthsRegex = Fe), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
    }),
    (Lt.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ? (h(this, '_monthsRegex') || ze.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex)
      ...
      for (
        ...
        if (
          ...
          this._weekdaysParse[s] ||
            ((d = '^' + this.weekdays(n, '') + '|^' + this.weekdaysShort(n, '') + '|^' + this.weekdaysMin(n, '')),
    ...
    (Lt.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (h(this, '_weekdaysRegex') || qe.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (h(this, '_weekdaysRegex') || (this._weekdaysRegex = Ze), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
    }),
    (Lt.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ? (h(this, '_weekdaysRegex') || qe.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        : (h(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = $e),
          this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
    }),
    (Lt.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ? (h(this, '_weekdaysRegex') || qe.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
  ...
  (Kt.isValid = function () {
    ...
    (Kt._bubble = function () {
      var e,
        ...
        i = this._data;
      return (
        (0 <= d && 0 <= r && 0 <= _) || (d <= 0 && r <= 0 && _ <= 0) || ((d += 864e5 * pt(Tt(_) + r)), (_ = r = 0)),
  ...
  function Ms(e, a, t) {
    ...
    return (
      ...
      2 !== e ? s : void 0 !== (d = {m: 'v', b: 'v', d: 'z'})[(n = s).charAt(0)] ? d[n.charAt(0)] + n.substring(1) : n)
    );
  }
  function hs(e, a, t) {
    var s = e + ' ';
      ...
      ordinal: function (e) {
        ...
        return (
          20 < e
            ...
            : 0 < e &&
              (a = ['', 'af', 'il', 'ydd', 'ydd', 'ed', 'ed', 'ed', 'fed', 'fed', 'fed', 'eg', 'fed', 'eg', 'eg', 'fed', 'eg', 'eg', 'fed', 'eg', 'fed'][e]),
          e + a
        );
      },
      week: {dow: 1, doy: 4},
  ...
  l.defineLocale('fi', {
    ...
    relativeTime: {future: '%s p\xe4\xe4st\xe4', past: '%s sitten', s: Is, ss: Is, m: Is, mm: Is, h: Is, hh: Is, d: Is, dd: Is, M: Is, MM: Is, y: Is, yy: Is},
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: {dow: 1, doy: 4},
  }),
  ...
  l.defineLocale('hu', {
    ...
    relativeTime: {future: '%s m\xfalva', past: '%s', s: Xs, ss: Xs, m: Xs, mm: Xs, h: Xs, hh: Xs, d: Xs, dd: Xs, M: Xs, MM: Xs, y: Xs, yy: Xs},
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: {dow: 1, doy: 4},
  }),
  ...
  function Kn(e, a, t) {
    var s = ' ';
    return (
      (20 <= e % 100 || (100 <= e && e % 100 == 0)) && (s = ' de '), e + s + {ss: 'secunde', mm: 'minute', hh: 'ore', dd: 'zile', MM: 'luni', yy: 'ani'}[t]
    );
  }
  function Zn(e, a, t) {
    var s, n;
  ...
  function td(e, a, t, s) {
    ...
    switch (t) {
      ...
      case 'ss':
        return (n +=
          1 === e ? (a ? 'sekundo' : 'sekundi') : 2 === e ? (a || s ? 'sekundi' : 'sekundah') : e < 5 ? (a || s ? 'sekunde' : 'sekundah') : 'sekund');
      case 'm':
      ...
      case 'yy':
        return (n +=
          1 === e ? (a || s ? 'leto' : 'letom') : 2 === e ? (a || s ? 'leti' : 'letoma') : e < 5 ? (a || s ? 'leta' : 'leti') : a || s ? 'let' : 'leti');
    }
  }
  l.defineLocale('sk', {
    months: Qn,
  ...
  l.defineLocale('tr', {
    ...
    l.defineLocale('tzl', {
      ...
      relativeTime: {future: 'osprei %s', past: 'ja%s', s: ud, ss: ud, m: ud, mm: ud, h: ud, hh: ud, d: ud, dd: ud, M: ud, MM: ud, y: ud, yy: ud},
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: {dow: 1, doy: 4},
    }),
